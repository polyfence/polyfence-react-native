...
| `plugin_version` | string | `"3.0.0"` | Package version |
| `bridge_platform` | string | `"react-native"` | Bridge layer. Set automatically. |
| `core_version` | string | `"3.0.0"` | Native engine version from polyfence-core. Stamped automatically. |
...
### 2026-08-05 (package 3.0.0)
- Sample payload and field-reference tables refreshed to reflect package `3.0.0` and native `core_version` `3.0.0`. No new telemetry fields; version identifiers only.

### 2026-07-21 (package 2.1.0)
- Sample payload and field-reference tables refreshed to reflect package `2.1.0` and native `core_version` `1.0.14`. No new telemetry fields; version identifiers only.
